...
class OptimalStoppingGameConfigBase(metaclass=abc.ABCMeta):
    ...
    def __init__(self, p: float = 0.001, T_max: int = 5, L: int = 3, R_ST: int = 100, R_SLA: int = 10,
        ...
        """
        Abstract DTO class representing the configuration of the optimal stopping game
    ...
    def from_params_dict(params_dict: dict) -> "OptimalStoppingGameConfigBase":
        pass
