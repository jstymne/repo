...
def main(unused_argv):
    ...
    plt.savefig('exploit_biggame_piplotting2.png')

    save_name = "Exploit_weighted_dist4"
...
def create_plots(agents):
    ...
    plt.tight_layout()
    plt.savefig('pi_attacker_plot3_biggame2.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot2_biggame2.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot1_biggame2.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot3_biggame2.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot2_biggame2.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot1_biggame2.png')
