...
def main(unused_argv):
    ...
    plt.savefig('exploit_biggame_piplotting_rsla1.png')

    save_name = "Exploit_rlsa"
...
def create_plots(agents):
    ...
    plt.tight_layout()
    plt.savefig('pi_attacker_plot3_rsla.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot2_rsla.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot1_rsla.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot3_rsla.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot2_rsla.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot1_rsla.png')
