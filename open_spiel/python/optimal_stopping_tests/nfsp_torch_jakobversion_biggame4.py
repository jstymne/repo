...
def main(unused_argv):
    ...
    params["obs_dist"] = " ".join(list(map(lambda x: str(x),[25/100,25/100, 20/100,10/100,10/100,6/100,1/100,1/100,1/100,1/100,0])))
    params["obs_dist_intrusion"] = " ".join(list(map(lambda x: str(x),[1/100,1/100, 1/100,1/100, 6/100, 10/100,10/100, 20/100, 25/100, 25/100,0])))
    ...
    for ep in range(num_train_episodes):
        ...
        if (ep + 1) % eval_every == 0 and ep+1 > 9000:
            ep_array.append(ep)
            b_vec, pi1ar_d1, pi1ar_d2, pi1ar_d3, pi2ar_a1, pi2ar_a2, pi2ar_a3 = create_plots(agents)
            ...
            plt.tight_layout()
            plt.savefig('game_value_array_uniform.png')
    ...
    plt.savefig('exploit_biggame_piplotting_weirddist.png')

    save_name = "Exploit_weird_dist"
...
def create_plots(agents):
    ...
    plt.tight_layout()
    plt.savefig('pi_attacker_plot3_weirddist.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot2_weirddist.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_attacker_plot1_weirddist.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot3_weirddist.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot2_weirddist.png')
    ...
    plt.ylabel("Action probability")
    plt.tight_layout()
    plt.savefig('pi_defender_plot1_weirddist.png')
    
    
    print("Plots created")
    return b_vec, pi1ar_d1, pi1ar_d2, pi1ar_d3, pi2ar_a1, pi2ar_a2, pi2ar_a3
