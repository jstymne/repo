...
def main(unused_argv):
    ...
    network_parameters = {'batch_size': 256, 'hidden_layers_sizes': [128,128,128], 'memory_rl': 600000, 'memory_sl': 30000000, 'rl_learning_rate': 0.1, 'sl_learning_rate': 0.005}
...
def evaluate_agents(agents, expl_array, approx_expl_array, game_value_array, game_value_array_random, game_value_array_heur, \
    ...
    save_name = "Exploit_new_code_base_with_good_params_leduc_1m_morerint" + str(experiment_no)
